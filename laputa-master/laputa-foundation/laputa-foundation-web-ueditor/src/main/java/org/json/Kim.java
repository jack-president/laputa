...
public class Kim
{
            ...
            throws JSONException
    {
        ...
        else
        {
            ...
            if (((c2 & 0x80) == 0) && (character > 16383) && (character <= 1114111) && (
                    (character < 55296) || (character > 57343))) {
                return character;
            }
        }
            ...
            throws JSONException
    {
        ...
        return character <= 16383 ? 2 : character <= 127 ? 1 : 3;
    }
