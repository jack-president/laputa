...
public class SysFileBeanCopier {
    ...
    public static List<SysFile> sysFileModelToSysFileEntity(List<SysFileModel> sysFileModelList){
        List<SysFile> sysFileEntityList = BeanCopyUtil.listCopy(sysFileModelList,SysFile.class,sysFileModelToSysFileBeanCopier,sysFileModelToSysFileEntityConverter);
