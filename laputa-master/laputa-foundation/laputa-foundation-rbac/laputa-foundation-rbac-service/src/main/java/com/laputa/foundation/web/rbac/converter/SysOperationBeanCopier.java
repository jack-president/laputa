...
public class SysOperationBeanCopier {
    ...
    public static List<SysOperation> sysOperationModelToSysOperationEntity(List<SysOperationModel> sysOperationModelList){
        List<SysOperation> sysOperationEntityList = BeanCopyUtil.listCopy(sysOperationModelList,SysOperation.class,sysOperationModelToSysOperationBeanCopier,sysOperationModelToSysOperationEntityConverter);
