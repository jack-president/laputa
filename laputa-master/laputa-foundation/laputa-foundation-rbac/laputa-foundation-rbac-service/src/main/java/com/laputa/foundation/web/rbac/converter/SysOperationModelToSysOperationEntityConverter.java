    ...
    public Object convert(Object value, Class target, Object context) {
        if (context.toString().equals("setChildren")) {
            ...
            if (childrenIdList != null && childrenIdList.size() > 0) {
                List<com.laputa.foundation.web.rbac.entity.SysOperation> children = new java.util.ArrayList<>(childrenIdList.size());
        ...
        if (context.toString().equals("setBelongtoSysPermissionCollection")) {
            ...
            if (belongtoSysPermissionCollectionIdList != null && belongtoSysPermissionCollectionIdList.size() > 0) {
                List<com.laputa.foundation.web.rbac.entity.SysOperationBelongtoRelationSysPermission> belongtoSysPermissionCollection = new java.util.ArrayList<>(belongtoSysPermissionCollectionIdList.size());
