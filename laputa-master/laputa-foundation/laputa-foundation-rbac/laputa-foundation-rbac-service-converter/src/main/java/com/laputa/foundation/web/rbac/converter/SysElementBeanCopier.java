...
public class SysElementBeanCopier {
    ...
    public static List<SysElement> sysElementModelToSysElementEntity(List<SysElementModel> sysElementModelList){
        List<SysElement> sysElementEntityList = BeanCopyUtil.listCopy(sysElementModelList,SysElement.class,sysElementModelToSysElementBeanCopier,sysElementModelToSysElementEntityConverter);
