...
public class SysMenuBeanCopier {
    ...
    public static List<SysMenu> sysMenuModelToSysMenuEntity(List<SysMenuModel> sysMenuModelList){
        List<SysMenu> sysMenuEntityList = BeanCopyUtil.listCopy(sysMenuModelList,SysMenu.class,sysMenuModelToSysMenuBeanCopier,sysMenuModelToSysMenuEntityConverter);
