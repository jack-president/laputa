...
public class SysUserGroupBeanCopier {
    ...
    public static List<SysUserGroup> sysUserGroupModelToSysUserGroupEntity(List<SysUserGroupModel> sysUserGroupModelList){
        List<SysUserGroup> sysUserGroupEntityList = BeanCopyUtil.listCopy(sysUserGroupModelList,SysUserGroup.class,sysUserGroupModelToSysUserGroupBeanCopier,sysUserGroupModelToSysUserGroupEntityConverter);
