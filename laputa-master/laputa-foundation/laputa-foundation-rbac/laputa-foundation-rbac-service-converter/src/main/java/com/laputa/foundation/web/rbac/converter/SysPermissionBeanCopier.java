...
public class SysPermissionBeanCopier {
    ...
    public static List<SysPermission> sysPermissionModelToSysPermissionEntity(List<SysPermissionModel> sysPermissionModelList){
        List<SysPermission> sysPermissionEntityList = BeanCopyUtil.listCopy(sysPermissionModelList,SysPermission.class,sysPermissionModelToSysPermissionBeanCopier,sysPermissionModelToSysPermissionEntityConverter);
