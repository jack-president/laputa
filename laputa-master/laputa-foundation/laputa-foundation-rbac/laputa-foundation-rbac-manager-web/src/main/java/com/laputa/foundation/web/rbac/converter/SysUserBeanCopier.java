...
public class SysUserBeanCopier {
    ...
    public static List<SysUser> sysUserModelToSysUserEntity(List<SysUserModel> sysUserModelList){
        List<SysUser> sysUserEntityList = BeanCopyUtil.listCopy(sysUserModelList,SysUser.class,sysUserToSysUserModelBeanCopier,sysUserModelToSysUserEntityConverter);
