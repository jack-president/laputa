...
public class SysRoleBeanCopier {
    ...
    public static List<SysRole> sysRoleModelToSysRoleEntity(List<SysRoleModel> sysRoleModelList){
        List<SysRole> sysRoleEntityList = BeanCopyUtil.listCopy(sysRoleModelList,SysRole.class,sysRoleToSysRoleModelBeanCopier,sysRoleModelToSysRoleEntityConverter);
