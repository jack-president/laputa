 ...
 */
public interface SysPermissionBelongtoRelationSysRoleJpaRepository
        extends JpaRepository<SysPermissionBelongtoRelationSysRole, Long>, JpaSpecificationExecutor<SysPermissionBelongtoRelationSysRole> {
}
