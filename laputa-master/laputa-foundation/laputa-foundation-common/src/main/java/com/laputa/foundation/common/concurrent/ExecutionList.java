 ...
 */
package com.laputa.foundation.common.concurrent;

import com.laputa.foundation.common.utils.NamedThreadFactory;
...
public final class ExecutionList {
    ...
    private static final Executor DEFAULT_EXECUTOR = new ThreadPoolExecutor(1, 10, 60000L, TimeUnit.MILLISECONDS,
            new SynchronousQueue<Runnable>(), new NamedThreadFactory("LaputaFutureCallbackDefault", true));
