 ...
 */
public class SysMenuConfigAttribute implements ConfigAttribute {

    private final SysMenuModel configAttribute;
    private final String attributePrefix;
    private final String attribute;

    public SysMenuConfigAttribute(SysMenuModel configAttribute) {
    ...
    public SysMenuModel getConfigAttribute() {
