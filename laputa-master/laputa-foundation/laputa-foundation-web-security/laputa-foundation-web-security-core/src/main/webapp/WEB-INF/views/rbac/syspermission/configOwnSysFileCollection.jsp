...
<c:url value="/rbac/syspermission/updateOwnSysFileCollection" var="updateOwnSysFileCollectionUrl"/>
...
<script>
    laputaKendoRequire(["kendo/js/kendo.grid", "kendo/js/kendo.button", "kendo/third/LaputaTreeViewCheckboxes/laputa.treeview.checkboxes", "kendo/js/kendo.datetimepicker"], function () {
        ...
        var initFun = function () {
            window.select =
                $("#sysFileSelect").kendoLaputaTreeviewCheckboxes({
                    treeview: {
                        ...
                        dataSource: sysFileDataSource.data()
                    }
                }).data("kendoLaputaTreeviewCheckboxes");

            select.value(window.parent.sysPermissionData.ownSysFileCollection);
            ...
            tj.bind("click", function () {
                ...
                if (select.value() != null) {
                    data.ownSysFileCollection = select.value();
                }
                $.ajax({
                        url: "${updateOwnSysFileCollectionUrl}",
                        type: 'POST',
        ...
        kendo.laputa.util.dataSourceFetchQuen([sysFileDataSource], initFun);
